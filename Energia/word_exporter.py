...
#
# Caminho de salvamento (Capítulo 5.1): detecta o usuário do Windows, cria a
# pasta se necessário (os.makedirs) e grava em:
#   C:\Users\<USUARIO>\Desktop\Instainfo Resumos\Energia\
#   Clipping_Energia_2026-09-07_14h30.docx
#
...
class WordExporter:
    ...
    def _descobrir_diretorio_saida():
        ...
        Desktop\\Instainfo Resumos\\Energia\\Resumos diários - Energia\\Relatórios
    ...
    def _montar_cabecalho(documento, data_execucao, periodo=None, quantidade_materias=None):
        ...
        Parágrafo 1: [⚡ Resumo de Energia] em NEGRITO, tamanho 14.
        ...
        run1 = p1.add_run(config.TITULO_DOCUMENTO)  # "⚡ Resumo de Energia"
        run1.bold = True
    ...
    def _concatenar_clientes(clientes):
        ...
        Ex.: ['ABRADEE', 'ABEEólica'] -> "ABRADEE, ABEEólica"
             ['ABRADEE', 'ABIAPE', 'ABRATE'] -> "ABRADEE, ABIAPE, ABRATE"
        """
        if not clientes:
            return ""
    ...
    def _montar_noticia(self, documento, noticia):
        ...
        Cenário B (CLIENTES_CITADOS com itens):
            ...
            Ex.: ▪️ *CanalEnergia com ABRADEE e ABEEólica* - Aneel pode
                 adiar leilão... - https://is.gd/liArN
    ...
    def exportar(
        ...
        Fluxo:
            1. Resolve o diretório de saída (Desktop\\Instainfo Resumos\\Energia).
            ...
            4. Salva com o nome Clipping_Energia_<data>_<hora>.docx.
        ...
        # ---- Nome do arquivo ----
        nome_base = config.ARQUIVO_FORMATO.format(agora)  # Clipping_Energia_2026-09-07_14h30.docx
    ...
    def _salvar_com_falha_segura(documento, caminho_arquivo):
        ...
        while True:
            try:
                ...
                tentativa += 1
                # Gera o novo nome: Clipping_Energia_2026-09-07_14h30_v2.docx
