...
class WordExporter:
    ...
    def _montar_noticia(self, documento, noticia):
        ...
        # O selo com o cliente só entra se a DEMANDA pedir destaque
        # (config.DESTAR_CLIPPING). Senão, matéria relevante fica no Cenário A.
        if clientes and config.DESTACAR_CLIPPING:
    ...
    def exportar(
        ...
        Fluxo:
            1. Resolve o diretório de saída (Desktop\\Instainfo Resumos\\
               Monitoramento Inteligente\\<Cliente>\\Relatórios).
            ...
            4. Salva com o nome Clipping_<Cliente>_<data>_<hora>.docx.
        ...
        # ---- Nome do arquivo ----
        # Ex.: Clipping_ALSHOP_2026-09-10_09h30.docx
        nome_base = config.ARQUIVO_FORMATO.format(
            cliente=cliente_slug, agora=agora
        )
